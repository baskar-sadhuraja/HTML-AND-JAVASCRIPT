...
function string() {
    ...
    document.getElementById("outputmin").innerHTML = "Shortest word(s): " +
    minstr.toString();
    document.getElementById("outputmax").innerHTML = "Longest word(s): " +
    maxstr.toString();
    }
    function bmi() {
    ...
    var l = ["pic/Dragon.jpg", "pic/Peach.jpg"];
